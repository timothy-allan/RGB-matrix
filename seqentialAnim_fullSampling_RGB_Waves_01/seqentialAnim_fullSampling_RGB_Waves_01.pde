...
void draw() { 
  ...
  for (pixelAcross = 0; pixelAcross < pixelsWide; pixelAcross++) {
    for (pixelDown = 0; pixelDown < pixelsHigh; pixelDown++) { 
      ...
      offsetAcross = pixelAcross * pixelWidth;
      offsetDown = pixelDown * rectHeight;
      ...
      fill(r, 0, 0);
      rect(offsetAcross, offsetDown, rectWidth, rectHeight);

      fill(0, g, 0);
      rect(offsetAcross + rectWidth, offsetDown, rectWidth, rectHeight);

      fill(0, 0, b);
      rect(offsetAcross +  (rectWidth * 2), offsetDown, rectWidth, rectHeight);
    }
  }
}
